...
def serializedATN():
    return [
        ...
        30,32,34,36,0,2,1,0,23,28,2,0,29,29,31,35,197,0,43,1,0,0,0,2,51,
        1,0,0,0,4,53,1,0,0,0,6,58,1,0,0,0,8,61,1,0,0,0,10,76,1,0,0,0,12,
        84,1,0,0,0,14,95,1,0,0,0,16,108,1,0,0,0,18,110,1,0,0,0,20,114,1,
        0,0,0,22,118,1,0,0,0,24,123,1,0,0,0,26,154,1,0,0,0,28,156,1,0,0,
        0,30,169,1,0,0,0,32,186,1,0,0,0,34,188,1,0,0,0,36,192,1,0,0,0,38,
        39,3,2,1,0,39,40,5,1,0,0,40,42,1,0,0,0,41,38,1,0,0,0,42,45,1,0,0,
        0,43,41,1,0,0,0,43,44,1,0,0,0,44,46,1,0,0,0,45,43,1,0,0,0,46,47,
        5,0,0,1,47,1,1,0,0,0,48,52,3,4,2,0,49,52,3,6,3,0,50,52,3,10,5,0,
        51,48,1,0,0,0,51,49,1,0,0,0,51,50,1,0,0,0,52,3,1,0,0,0,53,54,5,21,
        0,0,54,55,5,30,0,0,55,56,5,22,0,0,56,57,5,30,0,0,57,5,1,0,0,0,58,
        59,3,8,4,0,59,60,3,14,7,0,60,7,1,0,0,0,61,62,5,20,0,0,62,63,5,30,
        0,0,63,72,5,3,0,0,64,69,5,29,0,0,65,66,5,8,0,0,66,68,5,29,0,0,67,
        65,1,0,0,0,68,71,1,0,0,0,69,67,1,0,0,0,69,70,1,0,0,0,70,73,1,0,0,
        0,71,69,1,0,0,0,72,64,1,0,0,0,72,73,1,0,0,0,73,74,1,0,0,0,74,75,
        5,4,0,0,75,9,1,0,0,0,76,77,3,12,6,0,77,81,3,14,7,0,78,80,3,16,8,
        0,79,78,1,0,0,0,80,83,1,0,0,0,81,79,1,0,0,0,81,82,1,0,0,0,82,11,
        1,0,0,0,83,81,1,0,0,0,84,93,5,9,0,0,85,90,5,29,0,0,86,87,5,8,0,0,
        87,89,5,29,0,0,88,86,1,0,0,0,89,92,1,0,0,0,90,88,1,0,0,0,90,91,1,
        0,0,0,91,94,1,0,0,0,92,90,1,0,0,0,93,85,1,0,0,0,93,94,1,0,0,0,94,
        13,1,0,0,0,95,103,5,10,0,0,96,100,3,24,12,0,97,99,3,24,12,0,98,97,
        1,0,0,0,99,102,1,0,0,0,100,98,1,0,0,0,100,101,1,0,0,0,101,104,1,
        0,0,0,102,100,1,0,0,0,103,96,1,0,0,0,103,104,1,0,0,0,104,15,1,0,
        0,0,105,109,3,18,9,0,106,109,3,20,10,0,107,109,3,22,11,0,108,105,
        1,0,0,0,108,106,1,0,0,0,108,107,1,0,0,0,109,17,1,0,0,0,110,111,5,
        17,0,0,111,112,5,15,0,0,112,113,5,29,0,0,113,19,1,0,0,0,114,115,
        5,18,0,0,115,116,5,15,0,0,116,117,5,29,0,0,117,21,1,0,0,0,118,119,
        5,14,0,0,119,120,5,33,0,0,120,23,1,0,0,0,121,124,3,26,13,0,122,124,
        3,32,16,0,123,121,1,0,0,0,123,122,1,0,0,0,124,25,1,0,0,0,125,126,
        5,3,0,0,126,127,5,29,0,0,127,128,3,30,15,0,128,129,3,36,18,0,129,
        130,5,4,0,0,130,155,1,0,0,0,131,132,5,3,0,0,132,133,5,29,0,0,133,
        134,5,16,0,0,134,135,3,28,14,0,135,136,5,4,0,0,136,155,1,0,0,0,137,
        138,5,3,0,0,138,139,3,26,13,0,139,140,5,12,0,0,140,141,3,26,13,0,
        141,142,5,4,0,0,142,155,1,0,0,0,143,144,5,3,0,0,144,145,3,26,13,
        0,145,146,5,11,0,0,146,147,3,26,13,0,147,148,5,4,0,0,148,155,1,0,
        0,0,149,150,5,3,0,0,150,151,5,13,0,0,151,152,3,26,13,0,152,153,5,
        4,0,0,153,155,1,0,0,0,154,125,1,0,0,0,154,131,1,0,0,0,154,137,1,
        0,0,0,154,143,1,0,0,0,154,149,1,0,0,0,155,27,1,0,0,0,156,165,5,3,
        0,0,157,162,3,36,18,0,158,159,5,8,0,0,159,161,3,36,18,0,160,158,
        ...
        1,0,0,0,167,168,5,4,0,0,168,29,1,0,0,0,169,170,7,0,0,0,170,31,1,
        0,0,0,171,172,5,30,0,0,172,181,5,3,0,0,173,178,3,34,17,0,174,175,
        5,8,0,0,175,177,3,34,17,0,176,174,1,0,0,0,177,180,1,0,0,0,178,176,
        1,0,0,0,178,179,1,0,0,0,179,182,1,0,0,0,180,178,1,0,0,0,181,173,
        1,0,0,0,181,182,1,0,0,0,182,183,1,0,0,0,183,187,5,4,0,0,184,185,
        5,13,0,0,185,187,3,32,16,0,186,171,1,0,0,0,186,184,1,0,0,0,187,33,
        1,0,0,0,188,189,5,30,0,0,189,190,5,23,0,0,190,191,3,36,18,0,191,
...
class DroltaParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "S_COL", "DOT", "OPEN_PAR", "CLOSE_PAR", 
                      ...
                      "EQ", "NEQ", "LTE", "LT", "GTE", "GT", "VARIABLE", 
                      "IDENTIFIER", "BOOLEAN_LITERAL", "NULL", "INT_LITERAL", 
    ...
    def prog(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 3146240) != 0):
                self.state = 38
                self.prog_statement()
                self.state = 39
    ...
    def query(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 409600) != 0):
                self.state = 78
    ...
    def where_clause(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & 1073750024) != 0):
                self.state = 96
                self.where_statement()
                self.state = 100
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while (((_la) & ~0x3f) == 0 and ((1 << _la) & 1073750024) != 0):
                    self.state = 97
                    self.where_statement()
                    self.state = 102
                    self._errHandler.sync(self)
    ...
    def atom_list(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & 67108864000) != 0):
                self.state = 157
                self.atom()
                self.state = 162
                self._errHandler.sync(self)
    ...
    class AtomContext(ParserRuleContext):
        ...
        def BOOLEAN_LITERAL(self):
            return self.getToken(DroltaParser.BOOLEAN_LITERAL, 0)
