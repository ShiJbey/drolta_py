...
class DroltaParser(Parser):
    ...
    class NotFilterStmtContext(Filter_stmtContext):
        ...
        ):  # actually a DroltaParser.Filter_stmtContext
    ...
    class Predicate_stmtContext(ParserRuleContext):
        ...
        def positional_param_list(self):
            return self.getTypedRuleContext(
                DroltaParser.Positional_param_listContext, 0
            )
    ...
    def positional_param_list(self):
        ...
        localctx = DroltaParser.Positional_param_listContext(
    ...
    class Int_literalContext(AtomContext):
        ...
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a DroltaParser.AtomContext
            super().__init__(parser)
            self.copyFrom(ctx)
